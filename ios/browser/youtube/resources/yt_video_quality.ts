...
const youtubeQualityApiApi = new CrWebApi('youtubeQuality');
youtubeQualityApiApi.addFunction('resetQuality', resetQuality);
gCrWeb.registerApi(youtubeQualityApiApi);
