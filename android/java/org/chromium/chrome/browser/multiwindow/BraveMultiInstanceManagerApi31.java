...
class BraveMultiInstanceManagerApi31 extends MultiInstanceManagerApi31 {
    ...
    BraveMultiInstanceManagerApi31(
        ...
        // WIP: to suppress warning
        org.chromium.base.Log.e(TAG, "merge_windows_snackbar=" + R.string.merge_windows_snackbar);
    }
    ...
    public boolean handleMenuOrKeyboardAction(int id, boolean fromMenu) {
        if (id == org.chromium.chrome.R.id.move_to_other_window_menu_id) {
            ...
            // WIP: to suppress The field 'mIsMoveTabsFromSettings' is never read
            org.chromium.base.Log.e(TAG, "mIsMoveTabsFromSettings=" + mIsMoveTabsFromSettings);
        }
        return super.handleMenuOrKeyboardAction(id, fromMenu);
    }

    // WIP(AlexeyBarabash):
    // Moved to MultiInstanceOrchestratorImpl
    // https://source.chromium.org/chromium/chromium/src/+/1eff3e2dfcb821e6a6fbccae543632bb5ebbce98
    // Commented here to make it compile
    // @Override
